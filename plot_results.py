...
for m in models:
    ...
    plot_path = model_path + os.sep + model_name + os.sep + 'plots'
    os.makedirs(plot_path)
    training_log = glob.glob(model_path + os.sep + model_name + os.sep + '*training.log')
    ...
    for wt_folder, mut_folder, data_label in datasets:
        ...
        wt_data_file = glob.glob(
            model_path + os.sep + model_name + os.sep + 'test_outputs' + os.sep + wt_folder + os.sep + '*_predictions.csv')
        wtData = pandas.read_csv(wt_data_file[0])
        mut_data_file = glob.glob(
            model_path + os.sep + model_name + os.sep + 'test_outputs' + os.sep + mut_folder + os.sep + '*_predictions.csv')
